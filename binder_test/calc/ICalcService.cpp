...
::android::binder::Status BpCalcService::getRect(
  ...
  _aidl_ret_status =
      remote()->transact(ICalcService::GETRECT, _aidl_data, &_aidl_reply);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::binder::Status BpCalcService::add(int32_t a, int32_t b, int32_t c,
  ...
  _aidl_ret_status =
      remote()->transact(ICalcService::ADD, _aidl_data, &_aidl_reply);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status = _aidl_status.readFromParcel(_aidl_reply);
...
::android::binder::Status BpCalcService::basicTypes(
  ...
  _aidl_ret_status =
      remote()->transact(ICalcService::BASICTYPES, _aidl_data, &_aidl_reply);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status = _aidl_status.readFromParcel(_aidl_reply);
...
::android::binder::Status BpCalcService::addAsync(
  ...
  _aidl_ret_status =
      _aidl_data.writeStrongBinder(::test::ICalcCallback::asBinder(callback));
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status =
      remote()->transact(ICalcService::ADDASYNC, _aidl_data, &_aidl_reply);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status = _aidl_status.readFromParcel(_aidl_reply);
...
::android::binder::Status BpCalcService::InvokeCommand(
  ...
  _aidl_ret_status =
      remote()->transact(ICalcService::INVOKECOMMAND, _aidl_data, &_aidl_reply);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status = _aidl_status.readFromParcel(_aidl_reply);
...
::android::status_t BnCalcService::onTransact(
  ...
  switch (_aidl_code) {
    ...
    case Call::ADD: {
      ...
      ::android::binder::Status _aidl_status(
          add(in_a, in_b, in_c, &_aidl_return));
      _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
      if (((_aidl_ret_status) != (::android::OK))) {
        break;
      }
    ...
    case Call::BASICTYPES: {
      ...
      ::android::binder::Status _aidl_status(basicTypes(
          in_anInt, in_aLong, in_aBoolean, in_aFloat, in_aDouble, in_aString));
      _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
      if (((_aidl_ret_status) != (::android::OK))) {
        break;
      }
    ...
    case Call::ADDASYNC: {
      ...
      ::android::binder::Status _aidl_status(
          addAsync(in_a, in_b, in_c, in_callback));
      _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
      if (((_aidl_ret_status) != (::android::OK))) {
        break;
      }
    ...
    case Call::INVOKECOMMAND: {
      ...
      ::android::binder::Status _aidl_status(
          InvokeCommand(in_command, &out_result));
      _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
      if (((_aidl_ret_status) != (::android::OK))) {
        break;
      }
    ...
    default: {
      _aidl_ret_status = ::android::BBinder::onTransact(
